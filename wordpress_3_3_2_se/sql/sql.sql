...
(1, 1, 'Herr WordPress', '', 'http://wordpress.org/', '', '2012-02-27 05:46:36', '2012-02-27 05:46:36', 'Hej! Det här är en kommentar.<br />Gör så här om du vill radera en kommentar: logga in och visa kommentarerna till inlägget. Där kan du välja om du vill redigera eller radera dem.', 0, '1', '', '', 0, 0);
...
(1, 0, '_site_transient_timeout_theme_roots', '1330328796', 'yes'),
...
(5, 0, 'blogdescription', 'En till WordPress-webbplats', 'yes'),
...
(1, 1, '2012-02-27 05:46:36', '2012-02-27 05:46:36', 'Välkommen till WordPress. Det här är ditt första inlägg. Redigera det eller radera det. Sedan kan du börja blogga!', 'Hej världen!', '', 'publish', 'open', 'open', '', 'hej-varlden', '', '', '2012-02-27 05:46:36', '2012-02-27 05:46:36', '', 0, 'http://i-mscp-net/?p=1', 0, 'post', '', 1),
(2, 1, '2012-02-27 05:46:36', '2012-02-27 05:46:36', 'Detta är en exempelsida. Den skiljer sig från ett blogginlägg eftersom den är statisk och kommer att finnas på samma plats hela tiden, den kommer troligen att visas i din sidnavigering (i de flesta teman). De flesta börjar med en Om-sida som introducerar dem för potentiella besökare. Den skulle t.ex kunna ha följande innehåll: \n\n<blockquote> Hej där! Jag är cykelbud på dagen, blivande skådespelare på natten och detta är min blogg. Jag bor i Örebro, har en katt som heter Lurv och jag gillar Pina Coladas. (och att simma i Göta kanal).</blockquote>\n\n... eller något liknande detta:\n\n<blockquote>Den officiella svenska portalen för WordPress, WP-Support Sverige grundades 2007 och tillhandahåller svenska översättningar för WordPress, teman och tillägg. Behöver man hjälp med att komma igång eller stöter på problem så är WP-Support Sverige den perfekta platsen att få svensk support på. Du hittar portalen på wp-support.se.</blockquote>\n\nSom ny WordPress-användare bör du gå till <a href="http://i-mscp-net/wp-admin/">din adminpanel</a> för att ta bort denna sida och sedan skapa nya sidor för ditt innehåll. Ha det så kul!', 'Exempelsida', '', 'publish', 'open', 'open', '', 'exempelsida', '', '', '2012-02-27 05:46:36', '2012-02-27 05:46:36', '', 0, 'http://i-mscp-net/?page_id=2', 0, 'page', '', 0);
...
(1, 'admin', '$P$BzaBbBfjxCOn49jyZLsfTAm8Dgqfus/', 'admin', 'noreply@i-mscp.net', '', '2012-02-27 05:46:36', '', 0, 'admin');
