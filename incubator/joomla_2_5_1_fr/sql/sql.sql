...
--
-- Structure de la table `banner_clients`
--
...
--
-- Structure de la table `banner_tracks`
--
...
--
-- Structure de la table `content_frontpage`
--
...
--
-- Structure de la table `content_rating`
--
...
--
-- Structure de la table `core_log_searches`
--
...
(602, 'French (FR)', 'language', 'fr-FR', '', 0, 1, 1, 1, '{"legacy":false,"name":"French (FR)","type":"language","creationDate":"2012-02-02","author":"French translation team : joomla.fr","copyright":"Copyright (C) 2005 - 2012 Open Source Matters & joomla.fr. All rights reserved.","authorEmail":"traduction@joomla.fr","authorUrl":"www.joomla.fr","version":"2.5.1","description":"French site language for Joomla 2.5","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(603, 'French (FR)', 'language', 'fr-FR', '', 1, 1, 1, 1, '{"legacy":false,"name":"French (FR)","type":"language","creationDate":"2012-02-02","author":"French translation team : joomla.fr","copyright":"Copyright (C) 2005 - 2012 Open Source Matters & Joomla.fr. All rights reserved.","authorEmail":"traduction@joomla.fr","authorUrl":"www.joomla.fr","version":"2.5.1","description":"French administrator language for Joomla 2.5","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Structure de la table `finder_filters`
--
...
--
-- Structure de la table `finder_links`
--
...
--
-- Structure de la table `finder_links_terms0`
--
...
--
-- Structure de la table `finder_links_terms1`
--
...
--
-- Structure de la table `finder_links_terms2`
--
...
--
-- Structure de la table `finder_links_terms3`
--
...
--
-- Structure de la table `finder_links_terms4`
--
...
--
-- Structure de la table `finder_links_terms5`
--
...
--
-- Structure de la table `finder_links_terms6`
--
...
--
-- Structure de la table `finder_links_terms7`
--
...
--
-- Structure de la table `finder_links_terms8`
--
...
--
-- Structure de la table `finder_links_terms9`
--
...
--
-- Structure de la table `finder_links_termsa`
--
...
--
-- Structure de la table `finder_links_termsb`
--
...
--
-- Structure de la table `finder_links_termsc`
--
...
--
-- Structure de la table `finder_links_termsd`
--
...
--
-- Structure de la table `finder_links_termse`
--
...
--
-- Structure de la table `finder_links_termsf`
--
...
--
-- Structure de la table `finder_taxonomy`
--
...
--
-- Contenu de la table `finder_taxonomy`
--
...
--
-- Structure de la table `finder_taxonomy_map`
--
...
--
-- Structure de la table `finder_terms`
--
...
--
-- Structure de la table `finder_terms_common`
--
...
--
-- Contenu de la table `finder_terms_common`
--
...
--
-- Structure de la table `finder_tokens`
--
...
--
-- Structure de la table `finder_tokens_aggregate`
--
...
--
-- Structure de la table `finder_types`
--
...
--
-- Structure de la table `menu_types`
--
...
--
-- Contenu de la table `menu_types`
--
...
--
-- Structure de la table `messages_cfg`
--
...
--
-- Structure de la table `modules_menu`
--
...
--
-- Contenu de la table `modules_menu`
--
...
--
-- Structure de la table `newsfeeds`
--
...
--
-- Structure de la table `overrider`
--
...
--
-- Structure de la table `redirect_links`
--
...
--
-- Structure de la table `template_styles`
--
...
--
-- Contenu de la table `template_styles`
--
...
--
-- Structure de la table `update_categories`
--
...
--
-- Structure de la table `update_sites`
--
...
--
-- Contenu de la table `update_sites`
--

INSERT INTO `update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 0, 1329679015),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 0, 1329679015);

-- --------------------------------------------------------

--
-- Structure de la table `update_sites_extensions`
--
...
--
-- Contenu de la table `update_sites_extensions`
--
...
(42, 'Super Utilisateur', 'admin', 'noreply@i-mscp.net', '0a3808cfbfe2fdabd358e5a68bdefe1d:XSo6z51EzU5pxBix1FKs2RydM9FCWOBE', 'deprecated', 0, 1, '2012-02-19 19:16:27', '0000-00-00 00:00:00', '0', '');
...
--
-- Structure de la table `user_usergroup_map`
--
...
--
-- Contenu de la table `user_usergroup_map`
--
...
--
-- Structure de la table `viewlevels`
--
...
--
-- Contenu de la table `viewlevels`
--
